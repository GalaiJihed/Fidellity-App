...
class PinCodeScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => PinCodeScreenState();
}
...
class OtpScreen extends StatelessWidget {
  ...
  pinIndexSetup(String s) async {
    ...
    if (pinIndex == 4) {
      print(strPin);
      String url = AppConfig.URL_CHECK_CODE;
      SharedPreferences prefs = await SharedPreferences.getInstance();
      String phone = prefs.getString("PhoneNumber");
      print('SharedPref phone : ' + phone);
      Map<String, String> headers = {"Content-type": "application/json"};
      String json = '{"phoneNumber": "$phone","requestCode": "$strPin"}';
      // make POST request
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        color: Theme.mainColorAccent.withOpacity(0.1),
      ),
